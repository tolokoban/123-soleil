...
import RunView, { IRunViewProps } from './run-view'

function view(partialProps: Partial<IRunViewProps>) {
    const props: IRunViewProps = {
        // @TODO Set default props.
        ...partialProps
    }
    return Renderer.create(<RunView {...props} />).toJSON()
}

describe('<RunView/> in view', () => {
